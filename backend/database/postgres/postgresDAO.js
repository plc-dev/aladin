...
var PgClient = /** @class */ (function () {
    function PgClient(dbName) {
        var _this = this;
        this.connectionString = "postgresql://admin:admin@postgres:5432/"; //`${process.env.postgresConnection}/`;
    ...
    PgClient.prototype.connect = function () {
        var _this = this;
        try {
    ...
    PgClient.prototype.queryDB = function (query) {
    ...
    PgClient.prototype.tearDown = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
