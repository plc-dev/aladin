...
import { sqlQueryGenerator, sqlQueryValidator, importDatabase } from "./Tasks/SQL/SQLTaskWorker";
...
(async () => {
    try {
        ...
        const response = await asyncSleep(async () => await axios.post(`http://reverse-proxy:3000/api/fetchWorkerConfig`, {}));
